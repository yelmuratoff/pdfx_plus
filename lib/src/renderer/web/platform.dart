...
import 'package:pdfx_plus/src/renderer/interfaces/document.dart';
import 'package:pdfx_plus/src/renderer/interfaces/page.dart';
import 'package:pdfx_plus/src/renderer/interfaces/platform.dart';
import 'package:pdfx_plus/src/renderer/rgba_data.dart';
import 'package:pdfx_plus/src/renderer/web/pdfjs.dart';
import 'package:pdfx_plus/src/renderer/web/resources/document_repository.dart';
import 'package:pdfx_plus/src/renderer/web/resources/page_repository.dart';
...
class PdfxWeb extends PdfxPlatform {
  ...
  PdfDocument _open(Map<dynamic, dynamic> obj, String sourceName) => PdfDocumentWeb._(
        sourceName: sourceName,
        id: obj['id'] as String,
        pagesCount: obj['pagesCount'] as int,
      );

  Future<Map<String, dynamic>> _openDocumentData(ByteBuffer data, {String? password}) async {
...
class PdfPageWeb extends PdfPage {
  ...
  bool operator ==(Object other) =>
      other is PdfPageWeb && other.document.hashCode == document.hashCode && other.pageNumber == pageNumber;
...
class PdfPageImageWeb extends PdfPageImage {
  ...
  static Future<PdfPageImage?> render({
    ...
    final html.CanvasElement canvas = js.context['document'].createElement('canvas');
    ...
    await js_util.promiseToFuture<void>(pdfJsPage.render(renderContext).promise);
...
class PdfPageTextureWeb extends PdfPageTexture {
  ...
  @override
  bool operator ==(Object other) =>
      other is PdfPageTextureWeb && other.id == id && other.pageId == pageId && other.pageNumber == pageNumber;
  ...
  Future<bool> _renderRaw({
    ...
    await js_util.promiseToFuture<void>(page.renderer.render(rendererContext).promise);
