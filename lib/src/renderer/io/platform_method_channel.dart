...
import 'package:pdfx_plus/src/renderer/get_pixels/main.dart';
...
class PdfxPlatformMethodChannel extends PdfxPlatform {
  PdfDocument _open(Map<dynamic, dynamic> obj, String sourceName) => PdfDocumentMethodChannel._(
...
class PdfDocumentMethodChannel extends PdfDocument {
  ...
  @override
  bool operator ==(Object other) => other is PdfDocumentMethodChannel && other.id == id;
...
class PdfPageMethodChannel extends PdfPage {
  ...
  bool operator ==(Object other) =>
      other is PdfPageMethodChannel && other.document.hashCode == document.hashCode && other.pageNumber == pageNumber;
...
class PdfPageImageMethodChannel extends PdfPageImage {
  ...
  static Future<PdfPageImage?> render({
    ...
    if (format == PdfPageImageFormat.webp &&
        (UniversalPlatform.isIOS || UniversalPlatform.isWindows || UniversalPlatform.isMacOS)) {
  ...
  @override
  bool operator ==(Object other) =>
      other is PdfPageImageMethodChannel && other.bytes.lengthInBytes == bytes.lengthInBytes;
